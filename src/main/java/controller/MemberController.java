            ...
            if (cmd.equals("/signup.member")) {
                ...
                if (result) {
                    ...
                    if (sendResult) {
                        ...
                        jsonResponse.put("message", "메일 전송 시스템에 오류가 발생했습니다. 잠시 후 다시 시도 해주세요");
                    }
                } else {
                ...
                MemberDTO mdto = mdao.searchProfileInfo(id);
                ...
                request.setAttribute("formattedJoinDate", formattedJoinDate);
                ...
                String oriName = multi.getOriginalFileName("profileImage");
                String sysName = multi.getFilesystemName("profileImage");
